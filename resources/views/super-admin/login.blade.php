...
<link href="{{url('assets/admin/layout/css/themes/default.css')}}" rel="stylesheet" type="text/css" id="style_color"/>
...
<div class="logo">
	<a href="index.html">
	<img width="200" src="{{url('images/logo.png')}}" alt=""/>
	</a>
</div>
<!-- END LOGO -->
<!-- BEGIN LOGIN -->
<div class="content">
	<!-- BEGIN LOGIN FORM -->
<form class="login-form" action="{{url('super-admin/authenticate')}}" method="post">
        @csrf
    <h3 class="form-title">Sign In</h3>
		...
		<div class="form-actions">
			<button type="submit" class="btn btn-success uppercase center-block">Login</button>
		</div>
	</form>
	<!-- END LOGIN FORM -->
...
<div class="copyright">
	 2019 © Velox. Super Admin Dashboard
</div>
<!-- END LOGIN -->
